...
/**
 * copy  org.springframework.boot.loader
 * 修改创建 换继承为WapClassLoader
 ...
 * @since 1.0.0
 */
public class WapLaunchedURLClassLoader extends WapClassLoader {
     ...
     */
    public WapLaunchedURLClassLoader(URL[] urls) {
        this(false, urls);
    }
     ...
     * @param urls     the URLs from which to load classes and resources
     */
    public WapLaunchedURLClassLoader(boolean exploded, URL[] urls) {
        this(exploded, null, urls);
    }
     ...
     * @since 2.3.1
     */
    public WapLaunchedURLClassLoader(boolean exploded, Archive rootArchive, URL[] urls) {
        super(urls);
